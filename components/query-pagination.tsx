            ...
            <PaginationContent>
                ...
                {showLeftDots && (
                 ...
                 {Array.from({ length: totalPages }, (_, index) => index + 1)
                    ...
                    .map(pageNumber => (
                        <PaginationItem className="hidden sm:inline-block" key={`page-button-${pageNumber}`}>
                            <PaginationLink isActive={currentPage === pageNumber} href={createPageURL(pageNumber)}>
                                {pageNumber}
                            </PaginationLink>
                        </PaginationItem>
                    ))
